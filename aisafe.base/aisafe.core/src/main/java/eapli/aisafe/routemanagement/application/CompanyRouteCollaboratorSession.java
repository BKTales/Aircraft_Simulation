...
final class CompanyRouteCollaboratorSession {

    private CompanyRouteCollaboratorSession() {
    }
    ...
    static CompanyCollaboratorUser requireAirTransportCompanyCollaborator(
        ...
        if (collaborator.isEmpty()) {
            throw new IllegalStateException("Only registered air transport company collaborators may create routes.");
        }
