...
class AirTransportCompanyControllersDefaultConstructorCoverageTest {
    ...
    void defaultConstructorsDoNotThrowWhenPersistenceAndAuthzAreConfigured() {
        ...
        assertDoesNotThrow(() -> {
            ...
            new ListAirTransportCompaniesController();
        });
    }
    ...
    private void configureRepositoryFactoryForDefaultConstructor() {
        try {
            ...
            props.setProperty("persistence.repositoryFactory",
                    "eapli.aisafe.airtransportcompanymanagement.TestAirTransportCompanyControllersRepositoryFactory");
