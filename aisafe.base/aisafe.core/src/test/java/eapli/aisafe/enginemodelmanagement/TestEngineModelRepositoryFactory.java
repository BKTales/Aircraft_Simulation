package eapli.aisafe.enginemodelmanagement;
 ...
 */
public class TestEngineModelRepositoryFactory implements RepositoryFactory {
    ...
    public TestEngineModelRepositoryFactory() {
        manufacturers.save(new Manufacturer(ManufacturerId.valueOf("MAN01"), new ManufacturerName("M1"), new CountryCode("PT")));
    }
